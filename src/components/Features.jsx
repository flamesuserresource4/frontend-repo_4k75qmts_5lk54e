...
export default function Features() {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-indigo-50/70">
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <motion.div
              ...
              className="relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-md"
            >
              <div className="absolute -top-10 -right-10 h-24 w-24 rounded-full bg-indigo-100/50 blur-2xl" />
